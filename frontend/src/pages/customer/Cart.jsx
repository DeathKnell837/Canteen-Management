  ...
  if (items.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 animate-fade-in-up">
        <div className="w-24 h-24 bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl flex items-center justify-center mb-6 shadow-sm">
          <ShoppingBag className="w-10 h-10 text-gray-300" />
        </div>
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Your cart is empty</h2>
        <p className="text-gray-400 mb-8">Add some delicious Filipino food from the menu</p>
        <Link
          to="/menu"
            ...
            >
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className="w-8 h-8 rounded-lg border border-gray-200 flex items-center justify-center text-gray-500 hover:bg-gray-50 hover:border-gray-300 transition-all active:scale-90"
                >
              ...
              <span className="w-20 text-right font-bold text-gray-900 hidden sm:block">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-2xl border border-gray-100 p-6 sticky top-6 shadow-sm animate-slide-in-right">
            ...
            <div className="space-y-3 pt-1">
              ...
              <div className="flex justify-between font-bold text-gray-900 text-lg border-t border-dashed border-gray-200 pt-3 mt-3">
                <span>Total</span>
            ...
            <button
              onClick={clearCart}
              className="w-full mt-2 py-2.5 text-sm text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-xl transition-all"
            >
              Clear Cart
            </button>
